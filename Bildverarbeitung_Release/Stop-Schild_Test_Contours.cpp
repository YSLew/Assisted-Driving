...
int main()
{
	...
	//cv::VideoCapture videoCapture("C:/Users/Max/OneDrive/HTW/Master/SE Projekt/SE-Projekt_Videos/20151006_171614.mp4");

	videoCapture.set(CAP_PROP_FRAME_WIDTH, 960);
	videoCapture.set(cv::CAP_PROP_FRAME_HEIGHT, 540);
