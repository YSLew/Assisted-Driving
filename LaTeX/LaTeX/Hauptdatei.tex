...
\documentclass[
    ...
    index=totoc, % Index im Inhaltsverzeichnis auffïühren
...
% Seitennummerierung: Vor dem Hauptteil werden die Seiten in großen römischen Ziffern nummeriert.
\pagenumbering{Roman}
...
\begin{acronym}[DDR-SDRAM] % längste Abkürzung steht in eckigen Klammern
	\setlength{\itemsep}{-\parsep} % geringerer Zeilenabstand
	\input{Inhalt/Abkürzungen}
        \end{acronym}
% --------------------------------------------------------------------------------------
